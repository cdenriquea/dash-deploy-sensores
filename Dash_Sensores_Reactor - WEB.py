...
app.layout = html.Div([
  ...
  type="cube"),
   ...
   dcc.Tabs(id="tabs",children=[
      ...
      dcc.Tab(selected_className="hide-on-med-and-down",value='tab-1',label='Almacenamiento H2',style=tab_style, selected_style=tab_selected_style,
              children=html.Div([
              html.Div([
              html.Div(className="row",children=[
                       html.H4([html.H4([('Sensores Hidrogeno')],className="center-align",)],className="col s12 m12 l3"),
   ...
   html.P([
     ...
     daq.LEDDisplay(
      ...
      html.Div([html.Div(children='Tanque'),
       ...
       size=None,
        ...
        ],className="col s3 m2 l1"),#Tamaño Control
    ...
    html.Div(children=html.Div(id='graficas_1'), className='row', style={'backgroundColor': colores['fondo']}),
      ...
      dcc.Tab(selected_className="hide-on-med-and-down",value='tab-2',label='Generacion Panel',style=tab_style, selected_style=tab_selected_style,
              children=[
           html.Div([
   ...
   dcc.Loading( id="loading_2",
    ...
    html.Div(html.Div(id='graficas_2'), className='row', style={'backgroundColor': colores['fondo']}),
     ...
     ##TAB 3
      ...
      dcc.Tab(selected_className="hide-on-med-and-down",value='tab-3',label='Consumo Reactor',style=tab_style, selected_style=tab_selected_style,
              children=[
           html.Div([
...
@app.callback(
    [Output('led1', 'value'),
     Output('led2', 'value'),
     Output('led3', 'value')],
    [Input('actualizar_1b', 'n_intervals')]) #Leds 1
    ...
    for data_name in data_names:
        ...
        graficas_2.insert(0,html.Div(dcc.Graph(
            ...
            figure={'data': [data],'layout' : go.Layout(paper_bgcolor=colores['fondo'],
                                                        ...
                                                        autosize=True,
                                                        transition={'duration': 5,'easing': 'cubic-in-out'},
                                                        xaxis=dict(range=[min(t),max(t)],title='Tiempo [s]', ticklen= 3,autorange=False, zeroline=False, gridwidth= 1),
